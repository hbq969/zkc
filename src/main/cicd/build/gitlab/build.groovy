pipeline {
    ...
    stages {
        ...
        stage('下载代码') {
            ...
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '${BRANCH}']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'gitlab-code-clone', url: '${SCM_ADDRESS}']]])
            }
